package com.tariqaliiman.tariqaliiman.activities.custom;
...
//                sharingIntent.putExtra(Intent.EXTRA_TEXT, Settingsss.ChangeNumbers(context, "\""+aya.text +"\""+ ", " +ayaID+", "+sora.name + System.getProperty ("line.separator")+ "https://play.google.com/store/apps/details?id=com.tariqaliiman.tariqaliiman"));
